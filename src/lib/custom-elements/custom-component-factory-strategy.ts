// @ts-nocheck
// From: https://raw.githubusercontent.com/angular/angular/bdce769/packages/elements/src/component-factory-strategy.ts
...
export class ComponentNgElementStrategy implements NgElementStrategy {
  ...
  private eventEmitters = new ReplaySubject<
    Observable<NgElementStrategyEvent>[]
  >(1);

  /** Merged stream of the component's output events. */
  readonly events = this.eventEmitters.pipe(
    switchMap((emitters) => merge(...emitters))
  );
